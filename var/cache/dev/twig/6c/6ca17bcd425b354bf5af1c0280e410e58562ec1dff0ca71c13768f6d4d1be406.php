...
class __TwigTemplate_8353e5a1f7545abfcac3eb31c03a3caa0bebcf7b352660286863332c683d45e0 extends Twig_Template
{
    ...
    <table>
        ...
        if ($this->getAttribute(($context["user"] ?? $this->getContext($context, "user")), "birthDate", array())) {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute(($context["user"] ?? $this->getContext($context, "user")), "birthDate", array()), "Y-m-d H:i:s"), "html", null, true);
        }
        echo "</td>
            </tr>
            <tr>
...
{% block body %}
    ...
    <table>
        <tbody>
            ...
            <tr>
                <th>Birthdate</th>
                <td>{% if user.birthDate %}{{ user.birthDate|date('Y-m-d H:i:s') }}{% endif %}</td>
            </tr>
            <tr>
                <th>Creationdate</th>
...
{% endblock %}
", "user/show.html.twig", "/home/wilder/Documents/FLYAROUND/Flyaournd3/app/Resources/views/user/show.html.twig");
    }
}
