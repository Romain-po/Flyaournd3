...
class Flight extends \AppBundle\Entity\Flight implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'plane', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'departure', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'arrival', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'pilot', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'nbFreeSeats', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'seatPrice', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'takeOffTime', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'publicationDate', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'wasDone', '' . "\0" . 'AppBundle\\Entity\\Flight' . "\0" . 'flight'];
        }
